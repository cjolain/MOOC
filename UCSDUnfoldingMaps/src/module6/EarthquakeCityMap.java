...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		for(Feature airport : airports) {
			int altitude= Integer.parseInt(airport.getStringProperty("altitude"));
			if (altitude >9000)
	...
	private void sortAndPrint(int numToPrint){
		...
		for (int i = 0;i<numToPrint;i++){
			if (i==quakeMarkers.size()-1)
				break;
			System.out.println(((Marker) a[i]).getProperty("title"));
		}
	...
	private void addKey() {	
		...
		text("Airport Marker", xbase+50, ybase+220);
		
		rect(xbase+35-5, ybase+220-5, 10, 10);
